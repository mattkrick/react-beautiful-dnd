...
var Draggable = function (_Component) {
  ...
  function Draggable(props, context) {
    ...
    _this.setTransformRef = function (ref) {
      _this.transformRef = ref;
    };
    ...
    _this.getTransformOffset = (0, _memoizeOne2.default)(function (transformRef) {
      if (!transformRef) {
        return {
          left: 0,
          top: 0
    ...
    _this.getDraggingStyle = (0, _memoizeOne2.default)(function (dimension, isDropAnimating, movementStyle) {
      ...
      var transformOffset = _this.getTransformOffset(_this.transformRef);
    ...
    _this.getProvided = (0, _memoizeOne2.default)(function (isDragging, isDropAnimating, shouldAnimateDisplacement, dimension, dragHandleProps, movementStyle) {
      ...
      var provided = {
        ...
        transformRef: _this.setTransformRef,
        draggableProps: {
