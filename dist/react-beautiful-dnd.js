	...
	*/
	...
	var reducer = (function (state, action) {
	  ...
	  if (action.type === 'UPDATE_DROPPABLE_IS_COMBINE_ONLY') {
	    ...
	    !_target3 ? invariant(false, "Cannot find Droppable[id: " + _id3 + "] to toggle its isCombineOnly state") : void 0;
	    !(_target3.isCombineOnly !== isCombineOnly) ? invariant(false, "Trying to set droppable isCombineOnly to " + String(isCombineOnly) + "\n      but it is already " + String(_target3.isCombineOnly)) : void 0;
	...
	var createDimensionMarshal = (function (callbacks) {
	  ...
	  var updateDroppableIsCombineOnly = function updateDroppableIsCombineOnly(id, isCombineOnly) {
	    !entries.droppables[id] ? invariant(false, "Cannot update isCombineOnly flag of Droppable " + id + " as it is not registered") : void 0;
	...
	function checkOwnProps(props) {
	  ...
	  !(typeof props.isCombineOnly === 'boolean') ? invariant(false, 'isCombineOnly must be a boolean') : void 0;
