...
var isCombiningWith = function isCombiningWith(_ref) {
  ...
  var twoThirdsOfSize = size * (isCombineOnly ? 1 : 0.666);
...
var getCombineImpact = (function (_ref2) {
  var currentCenter = _ref2.pageBorderBoxCenterWithDroppableScrollChange,
      ...
      isCombineOnly = _ref2.isCombineOnly,
...
var moveToNextCombine = (function (_ref) {
  ...
  var location = previousImpact.destination || previousImpact.merge;
...
var reducer = (function (state, action) {
  ...
  if (action.type === 'UPDATE_DROPPABLE_IS_COMBINE_ONLY') {
    ...
    var _action$payload5 = action.payload,
        ...
        isCombineOnly = _action$payload5.isCombineOnly;
    var _target3 = state.dimensions.droppables[_id3];
    !_target3 ? process.env.NODE_ENV !== "production" ? invariant(false, "Cannot find Droppable[id: " + _id3 + "] to toggle its isCombineOnly state") : invariant(false) : void 0;
    !(_target3.isCombineOnly !== isCombineOnly) ? process.env.NODE_ENV !== "production" ? invariant(false, "Trying to set droppable isCombineOnly to " + String(isCombineOnly) + "\n      but it is already " + String(_target3.isCombineOnly)) : invariant(false) : void 0;

    var _updated2 = _extends({}, _target3, {
      isCombineOnly: isCombineOnly
    });
  ...
  if (action.type === 'DROP_COMPLETE') {
    var _action$payload7 = action.payload,
        _completed = _action$payload7.completed,
        shouldFlush = _action$payload7.shouldFlush;
    return {
      phase: 'IDLE',
...
var updateDroppableIsCombineOnly = function updateDroppableIsCombineOnly(args) {
  return {
...
var createDimensionMarshal = (function (callbacks) {
  ...
  var updateDroppableIsCombineOnly = function updateDroppableIsCombineOnly(id, isCombineOnly) {
    !entries.droppables[id] ? process.env.NODE_ENV !== "production" ? invariant(false, "Cannot update isCombineOnly flag of Droppable " + id + " as it is not registered") : invariant(false) : void 0;
  ...
  var marshal = {
    ...
    updateDroppableIsCombineOnly: updateDroppableIsCombineOnly,
...
var getSize = function getSize(_ref) {
  var isAnimatingOpenOnMount = _ref.isAnimatingOpenOnMount,
      ...
      isPlaceholderUsed = _ref.isPlaceholderUsed;
...
var getStyle = function getStyle(_ref2) {
  var isAnimatingOpenOnMount = _ref2.isAnimatingOpenOnMount,
      ...
      isPlaceholderUsed = _ref2.isPlaceholderUsed;
  var size = getSize({
...
function checkOwnProps(props) {
  ...
  !(typeof props.isCombineOnly === 'boolean') ? process.env.NODE_ENV !== "production" ? invariant(false, 'isCombineOnly must be a boolean') : invariant(false) : void 0;
...
function Droppable(props) {
  ...
  var isPlaceholderUsed = isCombineOnly ? Boolean(snapshot.draggingFromThisWith) : true;
